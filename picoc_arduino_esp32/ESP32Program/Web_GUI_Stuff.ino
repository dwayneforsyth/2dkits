String GetRidOfurlCharacters(String urlChars)
{
  ...
  {
    if (false) //urlChars[i] == '%')  // if the char found is '%'
    {
...
String RunningProgramGui()
{
  ...
  //Serial.println((char *)"Program is running. CHecking for goto statemets");
...
{
  //Serial.print(itemToBePrinted);
  sendContent((char *)itemToBePrinted.c_str());
  return;
}

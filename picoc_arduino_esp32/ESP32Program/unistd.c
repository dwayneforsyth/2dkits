...
/*    { UnistdExecvp,        "int execvp(char *, char *[]);" }, */
    ...
    { UnistdGetdtablesize,(char *)"int getdtablesize(void);" },
...
/*    { UnistdPthread_atfork,(char *)"int pthread_atfork(void (*)(void), void (*)(void), void(*)(void));" }, */
...
void UnistdSetupFunc(void)
{
    ...
    VariableDefinePlatformVar(NULL,(char *)"optarg", CharPtrType, (union AnyValue *)&optarg, TRUE);
    VariableDefinePlatformVar(NULL,(char *)"optind", &IntType, (union AnyValue *)&optind, TRUE);
    VariableDefinePlatformVar(NULL,(char *)"opterr", &IntType, (union AnyValue *)&opterr, TRUE);
    VariableDefinePlatformVar(NULL,(char *)"optopt", &IntType, (union AnyValue *)&optopt, TRUE);
}

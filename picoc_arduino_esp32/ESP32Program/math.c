...
{
    VariableDefinePlatformVar(NULL,(char *)"M_E", &FPType, (union AnyValue *)&M_EValue, FALSE);
    VariableDefinePlatformVar(NULL,(char *)"M_LOG2E", &FPType, (union AnyValue *)&M_LOG2EValue, FALSE);
    VariableDefinePlatformVar(NULL,(char *)"M_LOG10E", &FPType, (union AnyValue *)&M_LOG10EValue, FALSE);
    VariableDefinePlatformVar(NULL,(char *)"M_LN2", &FPType, (union AnyValue *)&M_LN2Value, FALSE);
    VariableDefinePlatformVar(NULL,(char *)"M_LN10", &FPType, (union AnyValue *)&M_LN10Value, FALSE);
    VariableDefinePlatformVar(NULL,(char *)"M_PI", &FPType, (union AnyValue *)&M_PIValue, FALSE);
    VariableDefinePlatformVar(NULL,(char *)"M_PI_2", &FPType, (union AnyValue *)&M_PI_2Value, FALSE);
    VariableDefinePlatformVar(NULL,(char *)"M_PI_4", &FPType, (union AnyValue *)&M_PI_4Value, FALSE);
    VariableDefinePlatformVar(NULL,(char *)"M_1_PI", &FPType, (union AnyValue *)&M_1_PIValue, FALSE);
    VariableDefinePlatformVar(NULL,(char *)"M_2_PI", &FPType, (union AnyValue *)&M_2_PIValue, FALSE);
    VariableDefinePlatformVar(NULL,(char *)"M_2_SQRTPI", &FPType, (union AnyValue *)&M_2_SQRTPIValue, FALSE);
    VariableDefinePlatformVar(NULL,(char *)"M_SQRT2", &FPType, (union AnyValue *)&M_SQRT2Value, FALSE);
    VariableDefinePlatformVar(NULL,(char *)"M_SQRT1_2", &FPType, (union AnyValue *)&M_SQRT1_2Value, FALSE);
}

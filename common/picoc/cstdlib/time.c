...
//DDF void StdTimegm(struct ParseState *Parser, struct Value *ReturnValue,
//DDF     struct Value **Param, int NumArgs)
//DDF {
//DDF     ReturnValue->Val->Integer = timegm(Param[0]->Val->Pointer);
//DDF }
#endif
...
//DDF    {StdTimegm, "int timegm(struct tm *);"},
#endif
    {NULL, NULL}
};
